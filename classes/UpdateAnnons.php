<?php
    ...
    class UpdateAnnons{
    	...
    	function annonsData($dbCon,$query){
    		$html="";
    		$allCategory="";
    		$allSubcategory="";
			$allState="";
    		...
    		$html.= "
						...
						Välj län:
						 ...
						 <input type='submit'  name='updateAnnons' value='Spara'>
						 <input type='submit'  name='deleteAnnons' value='Ta bort annonsen'>						 
						</form>
					";
    	...
    	function updateAnnonsData($dbCon, $query)
    	{
